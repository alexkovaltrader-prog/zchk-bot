...
# ── ИСТОРИЯ ЯРОСЛАВА ─────────────────────────────────────────────────────────
STORY_TEXT = """👤 *Меня зовут Ярослав — основатель ZCHK Capital*

Я не начинал как трейдер. До рынка у меня было несколько бизнесов — хоккейная школа, пиццерия, фудтрак. Всё закончилось в ковид.

В 2020 году я начал торговать. Первые 1.5 года — слив за сливом. Стандартный путь. Я не понимал почему рынок двигается — торговал хаотично как большинство.

Потом всё изменилось когда я нашёл системный подход без паттернов. Начал понимать нарратив рынка, ликвидность, структуру. Результат не заставил ждать:

💰 *$9,300* — первая крупная выплата от проп-фирмы
💰 *$10,396* — следующая выплата месяц спустя
💰 *$420,000+* — общая прибыль на реальном счёте

Сейчас я управляю капиталом через проп-фирмы до $200,000 и получаю 80% от прибыли. И обучаю других делать то же самое — системно, без угадывания.

*ZCHK Capital — это не очередной курс с паттернами. Это система мышления трейдера.*"""
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(
        ...
        f"Я бот ZCHK Capital — образовательной платформы по проп-трейдингу.\n\n"
